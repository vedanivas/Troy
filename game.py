...
from characters import spawnBarbarian, move_barbarians, spawnArcher, move_archers, spawnS_Archer, move_s_archers,spawnHealer, move_healers, spawnDragon, move_dragons, spawnBalloon, move_balloons, clearTroops
...
while(True):
    ...
    if ch == 'w':
        ...
        break
    # os.system('clear')
    move_barbarians(King, V,pt.movement)
    move_archers(King, V,pt.movement)
    move_s_archers(King, V,pt.movement)
    move_healers(King, V)
    move_dragons(V)
    move_balloons(V)
